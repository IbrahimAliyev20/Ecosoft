...
export default function ServiceCard({ service }: ServiceCardProps) {
  return (
    <Link href={`/services?service=${service.slug}`} className="block">
      <div className="relative flex gap-4 p-5 md:p-6 rounded-[20px] bg-gray-100 border-0 cursor-pointer hover:bg-cyan-50 transition-colors duration-200">
