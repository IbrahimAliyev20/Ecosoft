        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-6 w-full">
          ...
          >
            <Button
              variant={"default"}
              size="lg"
              className="w-full bg-[#10B981] hover:bg-[#059669] flex items-center gap-2 rounded-xl"
            >
              <Image
          ...
          <Link href="/contact" className="w-full">
            <Button
              variant={"default"}
              size="lg"
              className="w-full bg-[#06B6D4] hover:bg-[#0891B2] text-white flex items-center gap-2 rounded-xl"
            >
